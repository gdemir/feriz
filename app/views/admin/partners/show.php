<h4 class="page-title">Partner Bilgileri</h4>

<div class="form-horizontal">
  <div class="form-group">
    <label class="col-sm-1 control-label" for="name">Ad</label>
    <div class="col-sm-11">
      <input type="text" value="<?= $partner->name; ?>" class="form-control" name="name" id="name" disabled />
    </div>
  </div>
  <div class="form-group">
...
<form class="form-horizontal" action="/admin/partners/destroy" method="post">
  <input type="hidden" value="<?= $partner->id; ?>" id="id" name="id" />
  <div class="form-group">
    <div class="col-sm-offset-1 col-sm-11">
      <a class="btn btn-primary" href="/admin/partners/edit/<?= $partner->id; ?>">Düzenle</a>
