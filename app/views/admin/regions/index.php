<h4 class="page-title">Bölgeler</h4>
...
<table id="example" class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <form action="/admin/regions/destroy" method="post">
          <a href="/admin/regions/show/<?= $region->id; ?>"
            class="btn btn-default" role="button" title="Göster"><i class="fa fa-search"></i>
          </a>

          <a href="/admin/regions/edit/<?= $region->id; ?>"
    ...
    <?php } ?>
    <?php } else { ?>
    <tr class="text-center"><td colspan="4">Henüz Bölge mevcut değil</td></tr>
    <?php } ?>
  </tbody>
</table>
<a class="btn btn-primary" href="/admin/regions/create">Bölge Ekle</a>