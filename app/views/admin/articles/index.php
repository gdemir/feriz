...
<table id="example" class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <form action="/admin/articles/destroy" method="post">
    ...
    <?php } ?>
    <?php } else { ?>
    <tr class="text-center"><td colspan="4">Henüz Makale mevcut değil</td></tr>
    <?php } ?>
  </tbody>
</table>
<a class="btn btn-primary" href="/admin/articles/create">Makale Ekle</a>