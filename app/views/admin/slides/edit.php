...
<form class="form-horizontal" action="/admin/slides/update" accept-charset="UTF-8" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-11">
      <input type="text" value="<?= $slide->subject_en; ?>" class="form-control" name="subject_en" id="subject_en" />
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-11">
      <textarea class="form-control" rows="10" name="content_en" id="content_en"><?= $slide->content_en; ?></textarea>
    </div>
  </div>
  <div class="form-group">
